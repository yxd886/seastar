...
void create_native_net_device(boost::program_options::variables_map opts) {
    ...
    if (opts.count("dpdk-pmd")) {
        ...
        /*
         * patch by djp
         * pass opts["dpdk-port-idx"].as<unsigned>() as the port index
         * to create_dpdk_net_device function.
         */
...
boost::program_options::options_description nns_options() {
    ...
    opts.add_options()
        ...
        /*
         * patch by djp
         * Add a new program option, "--dpdk-port-idx",
         * so that we can specify which dpdk device is
         * used by the native networking stack.
         */
        ("dpdk-port-idx",
